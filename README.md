...
These binaries are built from llama.cpp with added support for EVR-1 tensor types. The `llama-completion` binary is a custom addition for single-shot text completion.
